	...
	public function form(){
		...
		if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
			...
			if($upload['result'] == "success"){ // Jika proses upload sukses
				...
				// Variabel $sheet tersebut berisi data-data yang sudah diinput di dalam xlsx yang sudha di upload sebelumnya
				$data['sheet'] = $sheet; 
	...
	public function import(){
		...
		foreach($sheet as $row){
			...
			if($numrow > 1){
				...
				$jk = $get[2]; // Ambil data jenis kelamin dari kolom C di csv
