                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('admin/update/') . $data->id_sakit ?>" method="post">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="text" name="nama" disabled class="form-control text-dark"
                                        value="<?= $data->nama  ?>">
                                </div>
                                <div class="form-group">
                                    <label>Kelas</label>
                                    <input type="text" name="kelas" disabled class="form-control text-dark"
                                        value="<?= $data->kelas  ?>">
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="tgl_sakit" class="form-control text-dark"
                                        value="<?= date('Y-m-d\TH:i', strtotime($data->tgl_sakit)) ?>">
                                </div>
                                <div class="form-group">
                                    <label>Tekanan Darah</label>
                                    <input type="text" name="tekanan_darah" class="form-control text-dark"
                                        value="<?= $data->tekanan_darah  ?>">
                                </div>
                                <div class="form-group">
                                    <label>Suhu</label>
                                    <input type="text" name="suhu" class="form-control text-dark"
                                        value="<?= $data->suhu  ?>">
                                </div>
                                <div class="form-group">
                                    <label>Keluhan</label>
                                    <textarea class="form-control" name="keluhan" rows="2"
                                        autofocus><?= $data->keluhan ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Diagnosa</label>
                                    <textarea class="form-control" name="diagnosa" rows="2"
                                        autofocus><?= $data->diagnosa ?></textarea>
                                </div>
                                <div class="form-group">
